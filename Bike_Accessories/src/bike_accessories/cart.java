...
//1st
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bike_accessories", "root", "");
            ...
            String sql = "select c.purchaseid,c.product,c.price,c.quantity,c.amount,ct.cartid,ct.total,ct.name from cart c, carttotal ct where c.purchaseid=9243013 AND ct.cartid=9243013";
